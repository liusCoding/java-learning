...
<body>
	<form action="BookServlet?action=add" method="post" id="form">
    		书名：<input type="text" name="bookName" id="bookName"  />
    		<input type="hidden" name="id" value="${book.id }">
    		<span id="bookNameSpan"></span><br>
    		作者：<input type="text" name="author" id="author"  /><span id="authorSpan"></span><br>
    		价格：<input type="text" name="price" id="price" /><span id="priceSpan"></span><br>
